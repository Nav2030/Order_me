...
class AppetizersMenuListPage extends StatefulWidget {
  @override
  _AppetizersMenuListPageState createState() => _AppetizersMenuListPageState();
}

class _AppetizersMenuListPageState extends State<AppetizersMenuListPage> {
  Future getPosts() async{
    var firestore = Firestore.instance;
    QuerySnapshot qn = await firestore.collection("foods").where('itemType',isEqualTo: 'Appetizers').getDocuments();
    return qn.documents;
  }
