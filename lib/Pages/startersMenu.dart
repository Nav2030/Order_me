...
class StartersMenuListPage extends StatefulWidget {
  @override
  _StartersMenuListPageState createState() => _StartersMenuListPageState();
}

class _StartersMenuListPageState extends State<StartersMenuListPage> {
  Future getPosts() async{
    var firestore = Firestore.instance;
    QuerySnapshot qn = await firestore.collection("foods").where('itemType',isEqualTo: 'Starters').getDocuments();
    return qn.documents;
  }
